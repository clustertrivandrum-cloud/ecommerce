...
CREATE UNIQUE INDEX payments_provider_provider_reference_uidx ON public.payments USING btree (provider, provider_reference) WHERE (provider_reference IS NOT NULL);
